...
resource "google_compute_instance" "main-instance-1" {
  ...
  metadata = {
    ...
    "ssh-keys" = <<EOT
         ${var.provisionninguser}:ssh-ed25519 AAAAC3NzaC1lZDI1NTE5AAAAIOkQ/4I65lRavhUi5xsaJAgqAMEdw+DfRiPc/S9Gzddc
         ${var.provisionninguser}:ssh-rsa  mobaxterm@pcoam
     EOT
  }
